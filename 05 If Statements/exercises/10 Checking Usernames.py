...
current_users = ["alex","james","wilson","ibeka","admin"]

new_users = ["wilson","ebuka","victor","focus","admin"]

low_current_users = [v.lower() for v in current_users]

for user in new_users:
    if (user.lower() in low_current_users):
        print("usernam is available")
    else:
        print("username is already been used")
